...
Climate change and habitat loss are pervasive, emergent threats to global biodiversity. Both climate and habitat change impact biodiversity through complex response pathways via additive effects, interactions, and complex feedback loops. A major theme of my research program is understanding how changing environments ultimately drive changes in animal community structure and composition. Currently, I am examining the how long-term climate change and short-term climate variability interacts with fire behavior and management practices to drive avian populations across the Sierra Nevada ecoregion in California, USA. To do this, I am leveraging a large-scale passive acoustic monitoring network (>1,400 ARUs and >1 million recording hours per year) to generate species detection for >80 species using the acoustic machine learning classifier BirdNET. Using Bayesian static and dynamic multi-species occupancy models I am quantifying the relative effects of fire, climate, and habitat on species-specific occupancy dynamics and community composition across the Sierra.
